...
@property (nonatomic,assign) BOOL isBackBtnClick;
...
-(void)initColor{
    ...
    self.navigationBar.barTintColor = NAVOrange;
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    ...
    UIBarButtonItem *backBtn = [[UIBarButtonItem alloc] initWithTitle:@"" style:UIBarButtonItemStylePlain target:self action:@selector(backClick)];
